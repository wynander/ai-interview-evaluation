"""Example custom cases. Copy to evals/custom_cases.py and add YOUR OWN 5+.
...
from src.eval import EvalCase

CUSTOM_CASES = [
    EvalCase(
        name="custom: ambiguous user clarification",
        turns=("What plan is Alex on?",),
        expected_answer="Ask which Alex (Alex Chen C234 vs Alexandra Chen C235).",
        expected_why="Example custom case: agent should clarify, not guess.",
        category="custom",
